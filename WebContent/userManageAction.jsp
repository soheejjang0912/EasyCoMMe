...
<%
	...
	int result = userDAO.update(new UserDTO(userID, userPassword, userEmail, SHA256.getSHA256(userEmail), false, userAdress, userPhone, userGender, userBirthday, userType));
